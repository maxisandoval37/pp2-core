...
public class ProductScraper {
    public List<Product> scrapeProducts(String productName) {
        //TODO validar productName vacio o invalido
        //TODO normalizar tildes y case
    ...
    private List<Product> scrapeStoreProductsByName2(String productName) {//TODO considerar como extension
        //---------------------Fravega---------------------//
        List<Product> productList = new ArrayList<>();
        String storeUrl = "https://www.fravega.com/l/?promociones=&sorting=LOWEST_SALE_PRICE&page=";//Los productos ya se encuentran ordenados por menor precio
        int totalPagSize = 667;

        for (int itPag = 1; itPag <= totalPagSize; itPag++) {
            try {
                Document documentHtml = Jsoup.connect(storeUrl+itPag).get();
    ...
    private List<Product> scrapeStoreProductsByName(String productName) {
        String storeUrl = "https://www.fravega.com/l/?keyword="+productName+"&sorting=LOWEST_SALE_PRICE&page=";
        int totalPages = 25;//TODO Obtener de la pagina por medio de un selector css
